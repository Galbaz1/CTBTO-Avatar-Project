...
from vector_search_tool import VectorSearchTool, SearchQuery, SearchResult
...
class RAGTestSuite:
    ...
    def _test_search_strategies(self):
        ...
        collections = ["ConferenceChunk", "ConferenceSession"]
        ...
        for query in test_queries:
            try:
                ...
                test_result = TestResult(
                    ...
                    collection="ConferenceChunk+ConferenceSession",
                    execution_time_ms=execution_time,
    ...
    def _test_performance_scenarios(self):
        ...
        for query in rapid_queries:
            try:
                ...
                results = self.search_tool.hybrid_search(query, "ConferenceChunk", limit=3)
...
"""
        ...
        summary_content += f"""
## Test Configuration
- **Collections Tested:** ConferenceChunk, ConferenceSession
