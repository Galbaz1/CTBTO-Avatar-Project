...
- **SnT25_Session**: Complete session information with session_id, speakers, venues, times
- **SnT25_GlossaryTerm**: Research paper chunks and abstracts with scientific_field, themes, authors

**Key Fields for UI Intelligence:**
- `session_id` (SnT25_Session): Maps directly to SessionCard components
- `speakers` (SnT25_Session): Extract speaker names for SpeakerCard rendering
- `theme` (SnT25_Session): Extract topics for TopicCard rendering  
- `description` (SnT25_Session): Full session descriptions ✅ CONFIRMED AVAILABLE
