...
### Data Collections
- **SnT25_GlossaryTerm** - Contextual content pieces
- **SnT25_Session** - Session metadata and descriptions
...
def enhanced_conference_search(self, query: str, search_mode: str = "comprehensive"):
    ...
    if search_mode == "comprehensive":
        ...
        session_results = self.hybrid_search(
            query=query, collection="SnT25_Session", limit=6
        )
        chunk_results = self.hybrid_search(
            query=query, collection="SnT25_GlossaryTerm", limit=3
        )
...
def decompose_complex_query(self, query: str) -> List[Dict]:
    ...
    sub_queries = [
        {"type": "semantic", "query": "quantum sensing", "collection": "SnT25_GlossaryTerm"},
        {"type": "filtered", "filters": {"speakers": ["Dr. Chen"]}, "collection": "SnT25_Session"},
        {"type": "filtered", "filters": {"date": "2025-09-11", "time_of_day": "morning"}, "collection": "SnT25_Session"}
    ]
