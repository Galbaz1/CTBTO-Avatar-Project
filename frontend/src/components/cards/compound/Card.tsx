...
/**
 * Card context for managing compact layout state
 */
 ...
 * @returns Card context containing layout preferences
 * @throws Error if used outside Card component
 */
const useCard = () => {
 ...
 */
type CardProps = {
  /** React children to render within the card */
...
/**
 * Enhanced Card component with sophisticated layout animations
 * Supports micro-updates and delta-driven state changes for voice-first interfaces
 */
const cardVariants = {
  hidden: {
    opacity: 0,
...
/**
 * Card - Enhanced card component with animation support
 *
 * Provides a flexible card container with:
 ...
 * @returns JSX element with animated card container
 */
  ...
  return (
    <CardContext.Provider value={{ compact }}>
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        // hover interactions removed for voice-first compliance
        className={cn(
