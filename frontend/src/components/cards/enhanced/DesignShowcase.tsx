...
import { PremiumSessionCardDefault, type PremiumTimetableSession } from './PremiumSessionCard';
...
const realSpeaker: SnT2025Speaker = {
  ...
  organization: "International Institute of Earthquake Engineering and Seismology (IIEES)",
  country: "Iran",
...
export const DesignShowcase: React.FC<DesignShowcaseProps> = ({ className }) => {
  return (
    <motion.div
    ...
    >
      <motion.div variants={itemVariants}>
        ...
        <p className="text-gray-600 mb-6">
          Professional card designs for the CTBT Science & Technology Conference 2025
        </p>
      </motion.div>
      ...
      {/* CTBTO Branding Info */}
      <motion.div variants={itemVariants} className="mt-8 p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg border">
        ...
        <p className="text-sm text-gray-600">
          Cards follow CTBTO brand guidelines with seafoam green (#7FCDCD) and navy blue (#204054) color scheme, 
          professional typography, and clean layouts optimized for the kiosk environment.
        </p>
      </motion.div>
    </motion.div>
  );
