(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_467c7a._.js", {
...
function ChatProvider({ children }) {
        ...
        "ChatProvider.useCallback[deleteChat]": (chatId)=>{
            ...
            if (currentChatId === chatId) {
                const remainingChats = chats.filter({
                    "ChatProvider.useCallback[deleteChat].remainingChats": (chat)=>chat.id !== chatId
                }["ChatProvider.useCallback[deleteChat].remainingChats"]);
    ...
    const addMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[addMessage]": (message, targetChatId)=>{
            ...
            setChats({
                "ChatProvider.useCallback[addMessage]": (prev)=>prev.map({
                        "ChatProvider.useCallback[addMessage]": (chat)=>{
                            if (chat.id === chatId) {
                                const updatedMessages = [
                                    ...chat.messages,
                                    newMessage
                                ];
                                const title = chat.title === 'New Chat' && message.role === 'user' ? message.content.slice(0, 50) + (message.content.length > 50 ? '...' : '') : chat.title;
                                return {
                                    ...chat,
                                    title,
    ...
    const updateLastMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatProvider.useCallback[updateLastMessage]": (content, componentData, targetChatId)=>{
            const chatId = targetChatId || currentChatId;
            if (!chatId) return;
            setChats({
                "ChatProvider.useCallback[updateLastMessage]": (prev)=>prev.map({
                        "ChatProvider.useCallback[updateLastMessage]": (chat)=>{
                            if (chat.id === chatId) {
                                const messages = [
                                    ...chat.messages
                                ];
                    ...
                    }["ChatProvider.useCallback[updateLastMessage]"])
            }["ChatProvider.useCallback[updateLastMessage]"]);
        }
    }["ChatProvider.useCallback[updateLastMessage]"], [
        currentChatId
...
_s(ChatProvider, "vQZ3aJyZ0yDeWr1kss7/5SuAAi0=");
_c = ChatProvider;
function useChat() {
    _s1();
...
//# sourceMappingURL=_467c7a._.js.map