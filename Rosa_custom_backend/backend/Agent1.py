...
Simplified version focused on natural conversation without function calling
"""
...
Always provide helpful, diplomatic responses appropriate for an international conference setting. Keep responses conversational and engaging while emphasizing the CTBTO's mission to save humanity."""
    ...
    def process_conversation_stream(self, messages: List[Dict]):
        ...
        try:
            ...
            # OPTIMIZED: Using GPT-4.1 as preferred and reasonable settings for natural conversation
            completion_stream = self.client.chat.completions.create(
                model="gpt-4.1",  # Using GPT-4.1 as preferred
                messages=full_messages,
                stream=True,
                max_tokens=500,  # Reasonable limit for natural conversation
